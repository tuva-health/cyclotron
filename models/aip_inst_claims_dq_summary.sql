...
round((select * from total_aip_inst_claims) * 100.0 /
(select * from total_institutional_claims),1) as field_value
...
round((select * from total_aip_inst_claims) * 100.0 /
(select * from total_claims),1) as field_value
...
round((select * from usable_aip_inst_claims) * 100.0 /
...
round((select * from aip_inst_claims_with_dq_problem) * 100.0 /
(select * from total_aip_inst_claims),1) as field_value
...
round((select * from aip_inst_claims_with_unusable_patient_id) * 100.0 /
(select * from total_aip_inst_claims),1) as field_value
...
round((select * from aip_inst_claims_with_unusable_diagnosis_code_1) * 100.0 /
(select * from total_aip_inst_claims),1) as field_value
...
round((select * from aip_inst_claims_with_unusable_atc) * 100.0 /
(select * from total_aip_inst_claims),1) as field_value
...
round((select * from aip_inst_claims_with_unusable_asc) * 100.0 /
(select * from total_aip_inst_claims),1) as field_value
...
round((select * from aip_inst_claims_with_unusable_ddc) * 100.0 /
(select * from total_aip_inst_claims),1) as field_value
...
round((select * from aip_inst_claims_with_unusable_facility_npi) * 100.0 /
(select * from total_aip_inst_claims),1) as field_value
...
round((select * from aip_inst_claims_with_unusable_rendering_npi) * 100.0 /
(select * from total_aip_inst_claims),1) as field_value
