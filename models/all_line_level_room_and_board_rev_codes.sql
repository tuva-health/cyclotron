...
(revenue_center_code in
  ...
  case
    when
(revenue_center_code in ('0115','0125','0135','0145','0155') ) then 1
    else 0
  end as hospice,
  ...
  case
    when
(revenue_center_code in ('0180','0182','0183','0185','0189') ) then 1
    else 0
  end as loa,
  ...
  case
    when 
(revenue_center_code in ('1000','1001','1002') ) then 1
    else 0
  end as behavioral
...
or
(revenue_center_code between '1000' and '1002')
)
