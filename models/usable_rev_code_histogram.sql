...
round( (select * from one_or_more_rev_codes) * 100.0 /
(select * from total_institutional_claims), 1)  as percent_of_institutional_claims
...
round( (select * from two_or_more_rev_codes) * 100.0 /
(select * from total_institutional_claims) , 1) as percent_of_institutional_claims
...
round( (select * from three_or_more_rev_codes) * 100.0 /
(select * from total_institutional_claims) , 1) as percent_of_institutional_claims
...
round( (select * from four_or_more_rev_codes) * 100.0 /
(select * from total_institutional_claims) , 1) as percent_of_institutional_claims
...
round( (select * from five_or_more_rev_codes) * 100.0 /
(select * from total_institutional_claims) , 1) as percent_of_institutional_claims
...
round( (select * from six_or_more_rev_codes) * 100.0 /
(select * from total_institutional_claims) , 1) as percent_of_institutional_claims
...
round( (select * from seven_or_more_rev_codes) * 100.0 /
(select * from total_institutional_claims) , 1) as percent_of_institutional_claims
...
round( (select * from eight_or_more_rev_codes) * 100.0 /
(select * from total_institutional_claims) , 1) as percent_of_institutional_claims
...
round( (select * from nine_or_more_rev_codes) * 100.0 /
(select * from total_institutional_claims) , 1) as percent_of_institutional_claims
...
round( (select * from ten_or_more_rev_codes) * 100.0 /
(select * from total_institutional_claims) , 1) as percent_of_institutional_claims
