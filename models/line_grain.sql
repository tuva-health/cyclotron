...
-- admisssion_date and discharge_date in our list of 'institutional' fields.
  case
    when  (bill_type_code is not null or
           ms_drg_code is not null or
	   apr_drg_code is not null or
	   admit_type_code is not null or
	   admit_source_code is not null or
	   discharge_disposition_code is not null or
	   revenue_center_code is not null  -- or
  ...
  case
    when  (valid_bill_type_code = 1 or
           valid_ms_drg_code = 1 or
	   valid_apr_drg_code = 1 or
	   valid_admit_type_code = 1 or
	   valid_admit_source_code = 1 or
	   valid_discharge_disposition_code = 1 or
	   valid_revenue_center_code = 1  -- or
